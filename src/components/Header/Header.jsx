...
const Header = ({ currentUser, cartDropdown, signUserOutStart }) => {
  return (
    <HeaderContainer>
      <LogoContainer to="/">
      ...
      <Nav>
        <Ul>
          ...
          <Li>
            {currentUser ? (
              <NavigationDiv onClick={signUserOutStart}>Sign Out</NavigationDiv>
            ) : (
...
export default connect(mapStateToProps, { signUserOutStart })(Header);
